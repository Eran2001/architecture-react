...
const HeroServices = () => {
  return (
    <div className="section hero-services bg-[#EBEAFF] text-[#000]">
      ...
      <div className="flex justify-center space-x-20 pt-10 servicesDivMain2">
        <div className="servicesDiv txt3">
          <p>
            Contrary to popular belief, Lorem Ipsum is not simply random text.
            It has roots in a piece of classical Latin literature from 45 BC,
            making it over 2000 years old. Richard McClintock, a Latin professor
      ...
      <h1 className="flex justify-center text-5xl pt-20 z-0 pb-10">Portfolios</h1>
    </div>
  );
};
